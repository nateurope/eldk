...
public:
  static ::gnu::javax::crypto::keyring::PasswordEncryptedEntry *decode (::java::io::DataInputStream *, jcharArray);
  static ::gnu::javax::crypto::keyring::PasswordEncryptedEntry *decode (::java::io::DataInputStream *);
  virtual void decrypt (jcharArray);
  virtual void encrypt (jcharArray);
  virtual void encode (::java::io::DataOutputStream *, jcharArray);
public:  // actually protected
  virtual void encodePayload ();
private:
  ::gnu::javax::crypto::mode::IMode *getMode (jcharArray, jint);
  static ::java::util::logging::Logger *log;
public:
  static const jint TYPE = 1L;

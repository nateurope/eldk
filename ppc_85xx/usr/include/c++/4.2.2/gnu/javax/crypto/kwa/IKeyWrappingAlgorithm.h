...
public:
  ...
  virtual jint wrap (jbyteArray, jint, jint, jbyteArray, jint) = 0;
  virtual jbyteArray wrap (jbyteArray, jint, jint) = 0;
  virtual jint unwrap (jbyteArray, jint, jint, jbyteArray, jint) = 0;
  virtual jbyteArray unwrap (jbyteArray, jint, jint) = 0;

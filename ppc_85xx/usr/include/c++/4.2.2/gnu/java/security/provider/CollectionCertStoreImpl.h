...
public:
  ...
  virtual ::java::util::Collection *engineGetCertificates (::java::security::cert::CertSelector *);
  virtual ::java::util::Collection *engineGetCRLs (::java::security::cert::CRLSelector *);
private:

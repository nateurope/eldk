...
#define NIS_CPTIME 18
extern  uint32_t * nis_cptime_3();
extern  uint32_t * nis_cptime_3_svc();
#define NIS_CHECKPOINT 19
...
extern bool_t xdr_nis_bound_endpoint ();
extern bool_t xdr_nis_bound_endpoint ();
extern bool_t xdr_nis_bound_directory ();
extern bool_t xdr_nis_bound_directory ();
extern bool_t xdr_nis_active_endpoint ();
extern bool_t xdr_nis_active_endpoint ();

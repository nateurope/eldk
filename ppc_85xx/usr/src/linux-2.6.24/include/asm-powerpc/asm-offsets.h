...
#define THREAD 464 /* offsetof(struct task_struct, thread)	 # */
#define MM 144 /* offsetof(struct task_struct, mm)	 # */
...
#define THREAD_EVR0 300 /* offsetof(struct thread_struct, evr[0])	 # */
#define THREAD_ACC 432 /* offsetof(struct thread_struct, acc)	 # */
#define THREAD_SPEFSCR 440 /* offsetof(struct thread_struct, spefscr)	 # */
#define THREAD_USED_SPE 444 /* offsetof(struct thread_struct, used_spe)	 # */
...
#define BUG_ENTRY_SIZE 8 /* sizeof(struct bug_entry)	 # */

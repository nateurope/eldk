cmd_arch/powerpc/kernel/asm-offsets.s := ppc_85xx-gcc -m32 -Wp,-MD,arch/powerpc/kernel/.asm-offsets.s.d  -nostdinc -isystem /home/amue/workspace/test/eldk/usr/bin/../lib/gcc/powerpc-linux/4.2.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Iarch/powerpc -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -O2 -msoft-float -pipe -Iarch/powerpc -ffixed-r2 -mmultiple -mno-altivec -mno-spe -funit-at-a-time -mno-string -Wa,-me500 -fomit-frame-pointer -g  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign     -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(asm_offsets)"  -D"KBUILD_MODNAME=KBUILD_STR(asm_offsets)" -fverbose-asm -S -o arch/powerpc/kernel/asm-offsets.s arch/powerpc/kernel/asm-offsets.c

deps_arch/powerpc/kernel/asm-offsets.s := \
  ...
  /home/amue/workspace/test/eldk/usr/bin/../lib/gcc/powerpc-linux/4.2.2/include/stdarg.h \
...
arch/powerpc/kernel/asm-offsets.s: $(deps_arch/powerpc/kernel/asm-offsets.s)

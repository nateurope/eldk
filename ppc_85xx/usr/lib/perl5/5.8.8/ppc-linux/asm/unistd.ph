...
unless(defined(&_ASM_I386_UNISTD_H_)) {
    eval 'sub _ASM_I386_UNISTD_H_ () {1;}' unless defined(&_ASM_I386_UNISTD_H_);
    ...
    eval 'sub __NR_security () {223;}' unless defined(&__NR_security);
    ...
    eval 'sub __syscall_return {
        my($type, $res) = @_;
	    eval q( &do {  &if (($res) >= (-125)) {  &errno = -($res); $res = -1; }  &return ($type) ($res); }  &while (0));
    ...
    eval 'sub _syscall1 {
        my($type,$name,$type1,$arg1) = @_;
	    eval q(\\"(assembly code)\\");
    }' unless defined(&_syscall1);
    eval 'sub _syscall2 {
        my($type,$name,$type1,$arg1,$type2,$arg2) = @_;
	    eval q(\\"(assembly code)\\");
    }' unless defined(&_syscall2);
    eval 'sub _syscall3 {
        my($type,$name,$type1,$arg1,$type2,$arg2,$type3,$arg3) = @_;
	    eval q(\\"(assembly code)\\");
    }' unless defined(&_syscall3);
    eval 'sub _syscall4 {
        my($type,$name,$type1,$arg1,$type2,$arg2,$type3,$arg3,$type4,$arg4) = @_;
	    eval q(\\"(assembly code)\\");
    }' unless defined(&_syscall4);
    eval 'sub _syscall5 {
        my($type,$name,$type1,$arg1,$type2,$arg2,$type3,$arg3,$type4,$arg4, 	  $type5,$arg5) = @_;
	    eval q(\\"(assembly code)\\");
    }' unless defined(&_syscall5);
    eval 'sub _syscall6 {
        my($type,$name,$type1,$arg1,$type2,$arg2,$type3,$arg3,$type4,$arg4, 	  $type5,$arg5,$type6,$arg6) = @_;
	    eval q(\\"(assembly code)\\");

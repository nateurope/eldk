...
unless(defined(&_TIME_H)) {
    ...
    if(!defined (defined(&__timespec_defined) ? &__timespec_defined : undef)  && ((defined (defined(&_TIME_H) ? &_TIME_H : undef)  && defined (defined(&__USE_POSIX199309) ? &__USE_POSIX199309 : undef)) || defined (defined(&__need_timespec) ? &__need_timespec : undef))) {
